...
const Testimonial = () => {
  ...
  className="absolute h-12 w-12 -left-14 top-1/2 transform -translate-y-1/2 bg-gray-700 hover:bg-gray-600 text-white text-2xl pb-1 rounded-full transition duration-200"
>
  &#8592;
</button>
  ...
  className="absolute h-12 w-12 pb-1 -right-14 top-1/2 transform -translate-y-1/2 bg-gray-600 hover:bg-gray-500 text-white text-2xl rounded-full transition duration-200"
>
  &#8594;
</button>
